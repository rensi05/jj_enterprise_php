...
class CheckBook extends Model
{
    ...
    protected $table = 'cheque_books'; 
     ...
     public static function CheckBookModel($table_name, $datatable_fields, $conditions_array, $getfiled, $request, $join_str = array()) {
        ...
        $data->whereDate('due_date', '>=', date('Y-m-d'));
...
//        }
     ...
     public static function pastCheckBookModel($table_name, $datatable_fields, $conditions_array, $getfiled, $request, $join_str = array()) {
        DB::enableQueryLog();
        $output = array();
        $data = DB::table($table_name)
                ->select($getfiled);

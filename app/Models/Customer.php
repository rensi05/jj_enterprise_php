...
//        }
    ...
    public static function CustomerReportModel($table_name, $datatable_fields, $conditions_array, $getfiled, $request, $join_str = array()) {
        DB::enableQueryLog();
        $output = array();
        ...
        $data = DB::table($table_name)
                ...
                ->selectRaw('(SELECT COUNT(*) FROM orders WHERE orders.customer_id = customers.id) as total_orders');
...
//        }
    ...
    public static function getCustomerOrder($table_name, $datatable_fields, $conditions_array, $getfiled, $request, $join_str = array(), $id) {
        DB::enableQueryLog();
        $output = array();
        $data = DB::table($table_name)
                ->select($getfiled);
